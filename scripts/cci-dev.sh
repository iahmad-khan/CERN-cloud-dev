...
PUPPET_HOSTGROUPS="cloud_adm:qa cloud_blockstorage cloud_compute:devenv cloud_container cloud_dashboard cloud_identity cloud_image:swap cloud_networking:1718-neutronsetup cloud_orchestration cloud_telemetry"
