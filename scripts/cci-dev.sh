...
PUPPET_MODULES="abrt afs apache:upstream_150 bridged cernlib cinder cloud_common cloud_monitoring concat filemapper firewall flume glance inifile kerberos keystone lemon limits logrotate motd mysql neutron:1748-neutrondev network nova openstack_clients:osclients-testingrepo osrepos psacct puppet puppetdbquery stdlib sudo sysctl teigi:tbag_teigiurl"
