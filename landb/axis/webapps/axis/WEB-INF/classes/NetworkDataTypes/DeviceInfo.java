...
public class DeviceInfo  implements java.io.Serializable {
    ...
    private NetworkDataTypes.InterfaceCard[] networkInterfaceCards;

    private NetworkDataTypes.InterfaceInformation[] interfaces;

    private boolean HCPResponse;

    private NetworkDataTypes.Blocking blocked;
    ...
    public DeviceInfo(
        ...
        NetworkDataTypes.InterfaceCard[] networkInterfaceCards,
        NetworkDataTypes.InterfaceInformation[] interfaces,
        boolean HCPResponse,
        NetworkDataTypes.Blocking blocked,
    ...
    /**
     * Gets the zone value for this DeviceInfo.
     *
     * @return zone
     */
    ...
    /**
     * Sets the zone value for this DeviceInfo.
     *
     * @param zone
     */
    ...
    /**
     * Gets the status value for this DeviceInfo.
     *
     * @return status
     */
    ...
    /**
     * Sets the status value for this DeviceInfo.
     *
     * @param status
     */
    ...
    /**
     * Gets the manufacturer value for this DeviceInfo.
     *
     * @return manufacturer
     */
    ...
    /**
     * Sets the manufacturer value for this DeviceInfo.
     *
     * @param manufacturer
     */
    ...
    /**
     * Gets the model value for this DeviceInfo.
     *
     * @return model
     */
    ...
    /**
     * Sets the model value for this DeviceInfo.
     *
     * @param model
     */
    ...
    /**
     * Gets the genericType value for this DeviceInfo.
     *
     * @return genericType
     */
    ...
    /**
     * Sets the genericType value for this DeviceInfo.
     *
     * @param genericType
     */
    ...
    /**
     * Gets the description value for this DeviceInfo.
     *
     * @return description
     */
    ...
    /**
     * Sets the description value for this DeviceInfo.
     *
     * @param description
     */
    ...
    /**
     * Gets the tag value for this DeviceInfo.
     *
     * @return tag
     */
    ...
    /**
     * Sets the tag value for this DeviceInfo.
     *
     * @param tag
     */
    ...
    /**
     * Gets the serialNumber value for this DeviceInfo.
     *
     * @return serialNumber
     */
    ...
    /**
     * Sets the serialNumber value for this DeviceInfo.
     *
     * @param serialNumber
     */
    ...
    /**
     * Gets the operatingSystem value for this DeviceInfo.
     *
    ...
    /**
     * Sets the operatingSystem value for this DeviceInfo.
     *
    ...
    /**
     * Gets the inventoryNumber value for this DeviceInfo.
     *
    ...
    /**
     * Sets the inventoryNumber value for this DeviceInfo.
     *
    ...
    /**
     * Gets the startDate value for this DeviceInfo.
     *
     * @return startDate
     */
    ...
    /**
     * Sets the startDate value for this DeviceInfo.
     *
     * @param startDate
     */
    ...
    /**
     * Gets the endDate value for this DeviceInfo.
     *
     * @return endDate
     */
    ...
    /**
     * Sets the endDate value for this DeviceInfo.
     *
     * @param endDate
     */
    ...
    /**
     * Gets the responsiblePerson value for this DeviceInfo.
     *
    ...
    /**
     * Sets the responsiblePerson value for this DeviceInfo.
     *
    ...
    /**
     * Gets the userPerson value for this DeviceInfo.
     *
     * @return userPerson
     */
    ...
    /**
     * Sets the userPerson value for this DeviceInfo.
     *
     * @param userPerson
     */
    ...
    /**
     * Gets the networkInterfaceCards value for this DeviceInfo.
     *
     * @return networkInterfaceCards
     */
    public NetworkDataTypes.InterfaceCard[] getNetworkInterfaceCards() {
        return networkInterfaceCards;
    }


    /**
     * Sets the networkInterfaceCards value for this DeviceInfo.
     *
     * @param networkInterfaceCards
     */
    public void setNetworkInterfaceCards(NetworkDataTypes.InterfaceCard[] networkInterfaceCards) {
        this.networkInterfaceCards = networkInterfaceCards;
    }


    /**
     * Gets the interfaces value for this DeviceInfo.
     *
     * @return interfaces
     */
    public NetworkDataTypes.InterfaceInformation[] getInterfaces() {
        return interfaces;
    }


    /**
     * Sets the interfaces value for this DeviceInfo.
     *
     * @param interfaces
     */
    public void setInterfaces(NetworkDataTypes.InterfaceInformation[] interfaces) {
        this.interfaces = interfaces;
    }


    /**
     * Gets the HCPResponse value for this DeviceInfo.
     *
     * @return HCPResponse
     */
    ...
    /**
     * Sets the HCPResponse value for this DeviceInfo.
     *
     * @param HCPResponse
     */
    ...
    /**
     * Gets the blocked value for this DeviceInfo.
     *
     * @return blocked
     */
    public NetworkDataTypes.Blocking getBlocked() {
        return blocked;
    }


    /**
     * Sets the blocked value for this DeviceInfo.
     *
     * @param blocked
     */
    public void setBlocked(NetworkDataTypes.Blocking blocked) {
        this.blocked = blocked;
    }


    /**
     * Gets the lastChangeDate value for this DeviceInfo.
     *
    ...
    /**
     * Sets the lastChangeDate value for this DeviceInfo.
     *
    ...
    /**
     * Gets the IPv6Ready value for this DeviceInfo.
     *
     * @return IPv6Ready
     */
    ...
    /**
     * Sets the IPv6Ready value for this DeviceInfo.
     *
     * @param IPv6Ready
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true &&
                  ...
                  ((this.networkInterfaceCards==null && other.getNetworkInterfaceCards()==null) ||
                   (this.networkInterfaceCards!=null &&
                    java.util.Arrays.equals(this.networkInterfaceCards, other.getNetworkInterfaceCards()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getNetworkInterfaceCards() != null) {
            for (int i=0;
                    i<java.lang.reflect.Array.getLength(getNetworkInterfaceCards());
                    i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getNetworkInterfaceCards(), i);
                if (obj != null &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:NetworkDataTypes", "DeviceInfo"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("networkInterfaceCards");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:NetworkDataTypes", "NetworkInterfaceCards"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:NetworkDataTypes", "InterfaceCard"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("interfaces");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:NetworkDataTypes", "Interfaces"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:NetworkDataTypes", "InterfaceInformation"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:NetworkDataTypes", "Blocked"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:NetworkDataTypes", "Blocking"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
